...
public class Sudokufile extends javax.swing.JFrame {
    ...
    private String solvedBoard[][]= {
     ...
     private void ShowSolution(){
         JButton predefinedbtns[]= {r2c1, r3c1, r3c3, r1c4, r2c5, r2c6, r3c5, 
             r1c7, r1c8, r1c9, r2c7, r2c9, r3c8, r5c2, r5c3, r6c2, r4c5, r4c6, 
             r6c4, r6c5, r4c8, r5c8, r5c7, r7c2, r8c1, r9c1, r9c2, r9c3, r7c5, 
         ...
         if(globalFlag == true)
         {
            ...
            for(int i=0;i<9;i++)
            {
                for(int j=0;j<9;j++)
                {
                    showsolutionActionPreffered.setText("Hide Solution");
                    boolean flag = true;
         ...
         {
             showsolutionActionPreffered.setText("Show Solution");
             globalFlag = true;
             ResetGame();
         }
   }
    ...
    private void initComponents() {
        ...
        resetbtnActionPerformed = new javax.swing.JButton();
        exitbtnActionPerformed = new javax.swing.JButton();
        showsolutionActionPreffered = new javax.swing.JButton();
        checkmovesActionPreferred = new javax.swing.JButton();
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(35, 39, -1, -1));
        ...
        getContentPane().add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(223, 39, -1, -1));
        ...
        getContentPane().add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(423, 39, -1, -1));
        ...
        getContentPane().add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(35, 227, -1, -1));
        ...
        getContentPane().add(jPanel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(223, 227, -1, -1));
        ...
        getContentPane().add(jPanel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(423, 227, -1, -1));
        ...
        getContentPane().add(jPanel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(35, 415, -1, -1));
        ...
        getContentPane().add(jPanel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(223, 415, -1, -1));
        ...
        getContentPane().add(jPanel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(423, 415, -1, -1));
        ...
        getContentPane().add(selectionBtn1, new org.netbeans.lib.awtextra.AbsoluteConstraints(35, 582, 51, 37));
        ...
        getContentPane().add(selectionBtn2, new org.netbeans.lib.awtextra.AbsoluteConstraints(92, 582, 51, 37));
        ...
        getContentPane().add(selectionBtn3, new org.netbeans.lib.awtextra.AbsoluteConstraints(161, 582, 51, 37));
        ...
        getContentPane().add(selectionBtn4, new org.netbeans.lib.awtextra.AbsoluteConstraints(218, 582, 51, 37));
        ...
        getContentPane().add(selectionBtn5, new org.netbeans.lib.awtextra.AbsoluteConstraints(281, 582, 51, 37));
        ...
        getContentPane().add(selectionBtn6, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 582, 51, 37));
        ...
        getContentPane().add(selectionBtn9, new org.netbeans.lib.awtextra.AbsoluteConstraints(527, 582, 51, 37));
        ...
        getContentPane().add(selectionBtn7, new org.netbeans.lib.awtextra.AbsoluteConstraints(413, 582, 51, 37));
        ...
        getContentPane().add(selectionBtn8, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 582, 51, 37));

        resetbtnActionPerformed.setBackground(new java.awt.Color(153, 153, 153));
        resetbtnActionPerformed.setText("Reset");
        resetbtnActionPerformed.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                resetbtnActionPerformedActionPerformed(evt);
            }
        });
        getContentPane().add(resetbtnActionPerformed, new org.netbeans.lib.awtextra.AbsoluteConstraints(38, 645, 99, 48));

        exitbtnActionPerformed.setBackground(new java.awt.Color(255, 0, 0));
        exitbtnActionPerformed.setText("Exit");
        exitbtnActionPerformed.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                exitbtnActionPerformedActionPerformed(evt);
            }
        });
        getContentPane().add(exitbtnActionPerformed, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 645, 99, 48));

        showsolutionActionPreffered.setBackground(new java.awt.Color(102, 255, 102));
        showsolutionActionPreffered.setText("Solution");
        showsolutionActionPreffered.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                showsolutionActionPrefferedActionPerformed(evt);
            }
        });
        getContentPane().add(showsolutionActionPreffered, new org.netbeans.lib.awtextra.AbsoluteConstraints(296, 645, 99, 48));

        checkmovesActionPreferred.setBackground(new java.awt.Color(0, 255, 255));
        checkmovesActionPreferred.setText("Check Moves");
        checkmovesActionPreferred.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                checkmovesActionPreferredActionPerformed(evt);
            }
        });
        getContentPane().add(checkmovesActionPreferred, new org.netbeans.lib.awtextra.AbsoluteConstraints(428, 645, 147, 48));
    ...
    private void resetbtnActionPerformedActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_resetbtnActionPerformedActionPerformed
        // TODO add your handling code here:
        JFrame frame = new JFrame("Reset");
        if(JOptionPane.showConfirmDialog(frame, "Confirm if you want to reset the game now...!",
                "Sudoko Puzzle",JOptionPane.YES_NO_OPTION)==JOptionPane.YES_NO_OPTION)
        {
            ResetGame();
        }
    }//GEN-LAST:event_resetbtnActionPerformedActionPerformed

    private void exitbtnActionPerformedActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_exitbtnActionPerformedActionPerformed
        // TODO add your handling code here:
        JFrame frame = new JFrame("Exit");
        if(JOptionPane.showConfirmDialog(frame, "Confirm if you want to Exit the game now...!",
                "Sudoko Puzzle",JOptionPane.YES_NO_OPTION)==JOptionPane.YES_NO_OPTION)
        {
            System.exit(0);
        }
    }//GEN-LAST:event_exitbtnActionPerformedActionPerformed

    private void showsolutionActionPrefferedActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_showsolutionActionPrefferedActionPerformed
        // TODO add your handling code here:
        ShowSolution();
    }//GEN-LAST:event_showsolutionActionPrefferedActionPerformed

    private void checkmovesActionPreferredActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkmovesActionPreferredActionPerformed
        // TODO add your handling code here:
        checkMoves();
    }//GEN-LAST:event_checkmovesActionPreferredActionPerformed
    ...
    private javax.swing.JButton checkmovesActionPreferred;
    private javax.swing.JButton exitbtnActionPerformed;
    ...
    private javax.swing.JButton resetbtnActionPerformed;
    ...
    private javax.swing.JButton showsolutionActionPreffered;
